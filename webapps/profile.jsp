        ...
        <div class="col py-5">
    		...
    		try
    	    {
                ...
                con.configure();
   	            ...
   	            Teacher teacher=ses.get(Teacher.class,tid);
   	            %>
   	     <div class="card shadow">
   	     <h3 class="text-center">Teacher Profile</h3><br><hr><br>
   	     <div class="transptext"><b>NAME: </b><b style="color:rgba(0,0,0,0.5);"><%=teacher.getTname()%></b></div>
   	     <hr>
   	     <div class="transptext"><b>E-MAIL: </b><b style="color:rgba(0,0,0,0.5);"><%=teacher.getTmail()%></b></div>
   	     <hr>
   	     <div class="transptext"><b>SUBJECT: </b><b style="color:rgba(0,0,0,0.5);"><%=teacher.getSubject()%></b></div>
   	     <hr>
   	     <div class="transptext"><b>AGE: </b><b style="color:rgba(0,0,0,0.5);"><%=teacher.getAge()%></b></div>
   	     </div>

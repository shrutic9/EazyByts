...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.3.0/font/bootstrap-icons.css">
  ...
  .card{margin: 0 auto; width:35%; padding:40px;}
        ...
        <div class="col py-5">
    		...
    		try
    	    {
                ...
                con.configure();
   	            ...
   	            int tid=(int) session.getAttribute("sid");
   	            Student student=ses.get(Student.class,tid);
   	            %>
   	     <div class="card shadow">
   	     <h3 class="text-center">Student Profile</h3><br><hr><br>
   	     <div class="transptext"><b>NAME: </b><b style="color:rgba(0,0,0,0.5);"><%=student.getName()%></b></div>
   	     <hr>
   	     <div class="transptext"><b>E-MAIL: </b><b style="color:rgba(0,0,0,0.5);"><%=student.getSemail()%></b></div>
   	     <hr>
   	     <div class="transptext"><b>CLASS: </b><b style="color:rgba(0,0,0,0.5);"><%=student.getSclass()%></b></div>
   	     <hr>
   	     <div class="transptext"><b>COLLEGE: </b><b style="color:rgba(0,0,0,0.5);"><%=student.getCollege()%></b></div>
   	     </div>

        ...
        <div class="card border border-light-subtle rounded-3 shadow">
          <div class="card-body p-3 p-md-4 p-xl-5 shadow">
            <div class="text-center mb-3">
              <a href="#!">
                <img src="https://upload.wikimedia.org/wikipedia/commons/c/cb/Student_icon.svg" alt="BootstrapBrain Logo" width="175" height="100">
              </a>
            </div>
            <h2 class="fs-6 fw-normal text-center text-secondary mb-4">Sign up as a Student</h2>
            <form action="studentReg" method="post">
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="sclass" id="sclass" placeholder="MCA" required>
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="col" id="college" required>

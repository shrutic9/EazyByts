      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
        <div class="card border border-light-subtle rounded-3 shadow">
          <div class="card-body p-3 p-md-4 p-xl-5 shadow">
            ...
            <h2 class="fs-6 fw-normal text-center text-secondary mb-4">Sign up at ZOmo</h2>
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="d-flex gap-2 justify-content-between">
                    ...
                    <a href="userLog.jsp" class="link-primary text-decoration-none">Already have an account? Login</a>
                  </div>
                </div>
                <div class="col-12">
